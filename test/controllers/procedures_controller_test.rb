...
class ProceduresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create procedure" do
    assert_difference("Procedure.count") do
      post procedures_url, params: { procedure: { content: @procedure.content, section_id: @procedure.section_id } }
    end
  ...
  test "should update procedure" do
    patch procedure_url(@procedure), params: { procedure: { content: @procedure.content, section_id: @procedure.section_id } }
